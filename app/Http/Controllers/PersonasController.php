...
class PersonasController extends Controller
{
    ...
    {
        $personas = Persona::orderByDesc('created_at')->paginate(10);
        $personasEliminadas = Persona::onlyTrashed()->orderByDesc('deleted_at')->get();
    ...
    {
        $registro = Persona::withTrashed()->findOrFail($persona);
        $registro->restore();
